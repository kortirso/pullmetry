...
# rubocop: disable Style/RescueStandardError, Style/RedundantBegin, Rails/FilePath
...
# rubocop: enable Style/RescueStandardError, Style/RedundantBegin, Rails/FilePath
