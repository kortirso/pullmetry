...
describe Insights::Time::ForIssueComment, type: :service do
  ...
  before do
    create :issue_comment, issue: issue2, comment_created_at: first_monday + 14.hours
  end

  it 'returns list of times', :aggregate_failures do
    expect(service_call[:result]).to eq([7_200])
