...
export const CompanyEditInsights = (props) => {
  ...
  const toggleInsightField = async (insightName) => {
    ...
    const result = await updateCompanyConfigurationRequest(props.companyId, { insight_fields: insightFields });
  ...
  const updateMainAttribute = async (value) => {
    const result = await updateCompanyConfigurationRequest(props.companyId, { main_attribute: value });
  ...
  const updateAverageType = async (value) => {
    const result = await updateCompanyConfigurationRequest(props.companyId, { average_type: value });
  ...
  const toggleInsightRatio = async () => {
    const result = await updateCompanyConfigurationRequest(props.companyId, { insight_ratio: !pageState.insightRatio });
  ...
  const updateInsightRatioType = async (value) => {
    const result = await updateCompanyConfigurationRequest(props.companyId, { insight_ratio_type: value });
