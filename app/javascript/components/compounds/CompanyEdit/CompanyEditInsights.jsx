      ...
      <Dropdown title="Insights">
        <div class="py-6 px-8">
          ...
          <div class="grid lg:grid-cols-2 gap-8 pb-8 mb-8 border-b border-gray-200">
            ...
            <div>
              <p>If this configuration is enabled then you can select working time of your company. This allows better calculations of average review time, because it will not count not-working time and weekends.</p>
            </div>
          </div>
